...
3. Build the `EZgate` scheme with signing disabled for UI and domain development.
...
- Do not add simulated traffic to production UI or present generated values as captured traffic.
